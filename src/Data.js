const FORM_ENDPOINT = "http://localhost:5000/Precio%20carro/predict_price";
const us_states = [
...
const maker_codes = ["Jeep", "Chevrolet", "BMW", "Cadillac", "Mercedes-Benz", "Toyota", "Buick", "Dodge", "Volkswagen", "GMC", "Ford", "Hyundai", "Mitsubishi", "Honda", "Nissan", "Mazda", "Volvo", "Kia", "Subaru", "Chrysler", "INFINITI", "Land", "Porsche", "Lexus", "MINI", "Lincoln", "Audi", "Ram", "Mercury", "Tesla", "FIAT", "Acura", "Scion", "Pontiac", "Jaguar", "Suzuki", ",Bentley"];

function getConfig() {
    return {FORM_ENDPOINT, us_states, model_codes, maker_codes};
}
